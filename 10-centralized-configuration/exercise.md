1. Generate a Client Config server and a client via https://start.spring.io/ . For the server you'll need 'Config Server' and 'Actuator' dependencies, for the client you'll need 'Config Client', 'Actuator' and 'REST'.
